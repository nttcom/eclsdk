...
class Proxy(proxy2.BaseProxy):
    ...
    def manage_vsphere_contract(self, contract_year, cores):
        ...
        """
        vsphere_contract = _vsphere_contract.VsphereContract()
        return vsphere_contract.manage_vsphere_contract(self.session, contract_year, cores)
    ...
    def renewal_vsphere_contract(self, contract_year, contract_renewal=None):
        ...
        """
        vsphere_contract = _vsphere_contract.VsphereContract()
        return vsphere_contract.renewal_vsphere_contract(self.session, contract_year, contract_renewal)
