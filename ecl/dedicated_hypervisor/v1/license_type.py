...
class LicenseType(resource2.Resource):
    resources_key = "license_types"
    resource_key = None
    base_path = '/license_types'
    ...
    #: description of th elicense.
    description = resource2.Body('description')
    #: true if the you can create license key by API
