...
class WasabiGateway(resource2.Resource,base.NetworkBaseResource):
    ...
    @classmethod
    def find(wgw, session, name_or_id, ignore_missing=False, **params):
        ...
        data = wgw.list(session, **params)

        result = wgw._get_one_match(name_or_id, data)
        ...
        raise exceptions.ResourceNotFound(
            "No %s found for %s" % (wgw.__name__, name_or_id))
