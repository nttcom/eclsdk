...
class FirewallPlan(resource2.Resource):
    ...
    # Properties
    #: Description of the Firewall Plan
    description = resource2.Body("description")
    #: Unique ID of the Firewall Plan
    id = resource2.Body("id")
    #: Name of the Firewall Plan
