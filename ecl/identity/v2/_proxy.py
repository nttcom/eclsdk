...
from ecl.identity.v2 import role as _role
from ecl.identity.v2 import tenant as _tenant
from ecl.identity.v2 import user as _user
...
class Proxy(proxy.BaseProxy):
    ...
    def delete_role(self, role, ignore_missing=False):
        ...
        :param role: The value can be either the ID of a role or a
                     :class:`~ecl.identity.v2.role.Role` instance.
    ...
    def find_role(self, name_or_id, ignore_missing=False):
        ...
        :returns: One :class:`~ecl.identity.v2.role.Role` or None
        """
    ...
    def get_role(self, role):
        ...
        :returns: One :class:`~ecl.identity.v2.role.Role`
    ...
    def delete_tenant(self, tenant, ignore_missing=False):
        ...
        :param tenant: The value can be either the ID of a tenant or a
                       :class:`~ecl.identity.v2.tenant.Tenant` instance.
        :param bool ignore_missing: When set to ``False``
                    :class:`~ecl.exceptions.ResourceNotFound` will be
    ...
    def find_tenant(self, name_or_id, ignore_missing=False):
        ...
        :param bool ignore_missing: When set to ``False``
                    ...
                    When set to ``True``, None will be returned when
                    attempting to find a nonexistent resource.
        :returns: One :class:`~ecl.identity.v2.tenant.Tenant` or None
        """
    ...
    def get_tenant(self, tenant):
        ...
        :returns: One :class:`~ecl.identity.v2.tenant.Tenant`
        :raises: :class:`~ecl.exceptions.ResourceNotFound`
                 when no resource can be found.
        """
    ...
    def delete_user(self, user, ignore_missing=False):
        ...
        :param user: The value can be either the ID of a user or a
                     :class:`~ecl.identity.v2.user.User` instance.
        :param bool ignore_missing: When set to ``False``
                    :class:`~ecl.exceptions.ResourceNotFound` will be
    ...
    def find_user(self, name_or_id, ignore_missing=False):
        ...
        :param bool ignore_missing: When set to ``False``
                    ...
                    When set to ``True``, None will be returned when
                    attempting to find a nonexistent resource.
        :returns: One :class:`~ecl.identity.v2.user.User` or None
        """
    ...
    def get_user(self, user):
        ...
        :returns: One :class:`~ecl.identity.v2.user.User`
        :raises: :class:`~ecl.exceptions.ResourceNotFound`
                 when no resource can be found.
        """
