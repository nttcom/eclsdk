...
class Proxy(proxy2.BaseProxy):
    def users(self):
        ...
        :rtype: :class:`~ecl.sss.v2.user.User`
        """
    ...
    def find_user(self, user_id, ignore_missing=False):
        ...
        :return: One :class:`~ecl.sss.v2.user.User` or None
        """
    ...
    def get_user(self, user):
        ...
        :param user: ID of a user or a :class:`~ecl.sss.v2.user.User` instance.
        :return: One :class:`~ecl.sss.v2.user.User` or
    ...
    def tenants(self, **query):
        ...
        :rtype: :class:`~ecl.sss.v2.tenant.Tenant`
        """
    ...
    def find_tenant(self, tenant_id, ignore_missing=False):
        ...
        :param ignore_missing: When set to ``True``, None will be returned when
                    attempting to find a nonexistent resource.
        :return: One :class:`~ecl.sss.v2.tenant.Tenant` or None
        """
    ...
    def create_tenant(self, **attrs):
        ...
        :param attrs: Keyword arguments which will be used to create
                      a :class:`~ecl.sss.v2.tenant.Tenant`,
    ...
    def channels(self, get_contracts, **query):
        ...
        :rtype: :class:`~ecl.sss.v2.channel.Channel`
        """
    ...
    def create_contract(self, login_id, mail_address, channel_id, password=None,
        ...
        :return: :class:`~ecl.sss.v2.contract.Contract`
        """
        body = {}
        body["login_id"] = login_id
        body["mail_address"] = mail_address
    ...
    def contracts(self, channel_id, include_deleted="false"):
        ...
        :rtype: :class:`~ecl.sss.v2.contract.Contract`
        """
    ...
    def iam_groups(self, contract_id):
        ...
        :rtype: :class:`~ecl.sss.v2.iam_group.IAMGroup`
        """
    ...
    def create_iam_group(self, iam_group_name, contract_id=None,
        ...
        :return: :class:`~ecl.sss.v2.iam_group.IAMGroup`
        """
        body = {}
    ...
    def iam_roles(self, contract_id):
        ...
        :param contract_id: Contract ID ( Default is the Contract ID of API
            executing user ) .
        :return: A list of iam groups.
        :rtype: :class:`~ecl.sss.v2.iam_role.IAMRole`
        """
    ...
    def get_iam_role(self, iam_role_id):
        ...
        :return: :class:`~ecl.sss.v2.iam_role.IAMRole`
        """
    ...
    def create_workspace(self, workspace_name, description=None, contract_id=None):
        """
        Create workspace in the designated contract. 

        :param workspace_name: Workspace name.
        :param description: Descriptions for this workspace.
        :param contract_id: Contract ID for workspace creation.
        :return: The results of workspace creation
    ...
    def delete_workspace(self, workspace_id, ignore_missing=False):
        """
        Delete workspace. Only supser user (contract owner user) and partner
        user allowed. If the user delete workspace, the all user's token who
        has role to this workspace are expired even though 1 hour has not
        passed.

        :param workspace_id: Delete target workspace's workspace id.
        :param ignore_missing: When set to ``False``
                    :class:`~ecl.exceptions.ResourceNotFound` will be
                    raised when the user does not exist.
                    When set to ``True``, no exception will be set when
        ...
        :return: ``None``
        """
        return self._delete(_workspace.Workspace, workspace_id,
                            ignore_missing=ignore_missing)

    def update_workspace(self, workspace_id, description):
        """
        Updates the description for the designated workspace.

        :param workspace_id: The workspace id.
        :param description: New description of the workspace.
        :return: ``None``
        """
        body = {}
        body["description"] = description
    ...
    def add_workspace_role_assignment(self, user_id, workspace_id):
        """
        Add role between user and workspace.Contract owner user always have
        role to all workspaces in the contract. Only supser user
        (contract owner user) and partner user allowed.

        :param user_id: User's id of the role.
        :param workspace_id: Add target workspace's workspace id.
        :return: :class:`~ecl.sss.v2.workspace.Workspace`
        """
        body = {}
    ...
    def delete_workspace_role_assignment(self, workspace_id, user_id):
        """
        Delete role between user and workspace. Contract owner user always have
        role to all workspaces in the contract. Only supser user
        (contract owner user) and partner user allowed.
