...
"""
The :class:`~ecl.resource.Resource` class is a base
...
are of a component type, including :class:`~ecl.resource2.Body`,
:class:`~ecl.resource2.Header`, and :class:`~ecl.resource2.URI`.

For update management, :class:`~ecl.resource2.Resource` employs
a series of :class:`~ecl.resource2._ComponentManager` instances
...
class Resource(object):
    ...
    def to_dict(self, body=True, headers=True, ignore_none=False):
        ...
        :param bool body: Include the :class:`~ecl.resource2.Body`
                          attributes in the returned dictionary.
        :param bool headers: Include the :class:`~ecl.resource2.Header`
                             attributes in the returned dictionary.
    ...
    def list(cls, session, paginated=False, **params):
        ...
        :param dict params: These keyword arguments are passed through the
            :meth:`~ecl.resource2.QueryParamter._transpose` method
            to find if any of them match expected query parameters to be
            sent in the *params* argument to
            :meth:`~ecl.session.Session.get`. They are additionally
            checked against the
            :data:`~ecl.resource2.Resource.base_path` format string
...
def wait_for_status(session, resource, status, failures, interval, wait):
    ...
    :type resource: :class:`~ecl.resource.Resource`
