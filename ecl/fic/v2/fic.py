...
from ecl.fic import fic_service
from ecl.fic.v2.base import FicBaseResource
from ecl import resource2
from ecl import exceptions


class FICService(FicBaseResource):

    resource_key = "fic_service"
    resources_key = "fic_services"
    service = fic_service.FicService("v2.0")
...
class FICInterface(FicBaseResource):
