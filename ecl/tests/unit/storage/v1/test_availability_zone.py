...
from ecl.storage.v1 import availability_zone as az
...
class TestAvailabilityZone(testtools.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual('/availability_zone', sot.base_path)
    ...
    def test_basic_detail(self):
        ...
        self.assertEqual('availabilityZoneInfo', sot.resources_key)
        self.assertEqual('/availability_zone/detail', sot.base_path)
        self.assertTrue(sot.allow_list)
        self.assertEqual('storage', sot.service.service_type)
